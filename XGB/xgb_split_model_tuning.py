...
SplitSets, SplitDistributions =  CreateModelSplits(data_enc, level_out = 1, remove_outliers = True, replace_outliers = True, feature_dropout = True, plot_distributions = False, plot_correlations = False)
