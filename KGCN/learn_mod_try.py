...
class KGCNLearner:
    ...
    def train(self,
        ...
        Args:
            ...
            num_training_iterations: Number of training epochs
        ...
        for epoch in range(num_training_iterations): #changed from num_training_iterations
            ...
            for tr_input_graphs in training_batches:
                ...
                # TODO: Optimize learning rate?? Adaptive learning_raye\sqrt(time) for example?
                ...
                if epoch % log_every_epochs == 0:
                    ...
                    if train_writer is not None:
                        train_writer.add_summary(train_values["summary"], epoch)

                    feed_dict_ge = create_feed_dict(input_ph, target_ph, ge_input_graphs, ge_target_graphs)
            ...
            return train_values, test_values, training_info, feed_dict_tr #feed_dict_ge
