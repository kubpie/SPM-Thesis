...
def loss_ops_from_difference(target_op, output_ops, weighted=False):
    """
    ...
    if weighted:
        ...
        # weights = tf.gather(class_weights, target_op.nodes)
...
def loss_ops_preexisting_no_penalty(target_op, output_ops, weighted=False):
    """
