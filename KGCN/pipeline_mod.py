...
from KGCN.learn_mod import KGCNLearner
...
def pipeline(graphs,
    ...
    # train
        ...
        print("\n\nTRAINING\n\n")
        train_values, test_values, tr_info = learner.train(tr_input_graphs, # train_values, test_values, training_info, input_ph, target_ph, feed_dict
                                                 tr_target_graphs,
                                                 ge_input_graphs,
                                                 ge_target_graphs,
