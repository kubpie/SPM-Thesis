...
KEYSPACE =  "sampled_ssp_schema_kgcn" #"ssp_schema_slope0"  #"sampled_ssp_schema_kgcn"
URI = "localhost:48555"
...
data = data[(data.loc[:,'num_rays'] == 500) | (data.loc[:, 'num_rays'] == 1000)]
...
train_graphs, tr_ge_split = prepare_data(session, data, train_split=0.7, validation_split = 0.2)
